...
function BannerSection() {
  ...
  return (
    <div className="bg-gradient-stop-50 w-full bg-gradient-to-r from-white to-blue-500">
      <div ref={sectionRef} className="grid grid-cols-1 md:grid-cols-2">
        <div className="text-m py-1 text-center md:ml-[5.5rem] md:mt-[13rem] md:py-4 md:text-[1.2rem] lg:mb-5 lg:ml-[12.5rem]">
          <h1 className="justify-start md:relative md:mt-[-4rem] md:flex md:text-[1rem] lg:mt-[-8rem] lg:text-[1.2rem]">
            {" "}
            Got questions or other concerns?
          </h1>
          <h1 className="justify-start text-center text-2xl font-bold md:flex md:py-3 lg:text-[2rem] xl:text-[2.6rem]">
            Get in touch{" "}
        ...
        <div>
          <div>
            ...
            <div className="justify-start md:flex md:flex-col">
              ...
              <div>
                <h1 className="flex-start py-0.1 items-center text-center text-xs md:absolute md:mt-[14rem] md:flex md:py-4 md:text-[0.9rem] lg:mt-[12rem]">
                  Our Location
                </h1>
                <div className="flex justify-center md:block lg:block">
