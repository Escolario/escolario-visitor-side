...
function MissionVisionSection() {
  ...
  return (
    <motion.div
      ...
      className="z-1 container relative mx-auto my-14 mt-[-58rem] sm:mt-[-62rem] grid grid-cols-1 gap-4 px-12 sm:px-6 md:mt-[-7rem] md:grid-cols-3 md:px-[6rem] lg:mt-[-5rem] lg:grid-cols-3 xl:px-[16rem]"
    >
